...
OBS:  Para abrir a interface gráfica após a instalação, digite simplemente sanusb no terminal. 
A pasta SanUSBlinux.zip está também em anexo.
...
Este exemplo, bem como muitos outros da pasta Projeto1C18.X (compilador C18) e da pasta Projeto1XC8.X (compilador XC8), 
foram compilados em Linux, Windows e Mac OSX, e funcionaram normalmente.
